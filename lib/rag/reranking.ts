...
const PT_STOPWORDS = new Set([
  ...
  "deles","depois","do","dos","e","é","ela","elas","ele","eles","em","entre",
  "era","essa","essas","esse","esses","esta","estas","este","estes","eu","foi",
  "for","foram","há","isso","isto","já","lhe","lhes","mas","me","mesmo","meu",
  "meus","minha","minhas","muito","na","nas","não","no","nos","o","os","ou",
  "para","pela","pelas","pelo","pelos","por","qual","quando","que","se","sem",
  "seu","seus","só","sua","suas","também","te","tem","tendo","ter","tinha",
  "tive","toda","todas","todo","todos","tu","um","uma","umas","uns","você",
  "vocês","vos",
]);
